...
RTL_ALL="rtl/pe_serdes.v rtl/pe_nrzi.v rtl/pe_manch.v rtl/pe_bitstuff.v rtl/pe_codec_mux.v rtl/pe_crc.v rtl/pe_dru.v rtl/pe_cpu.v rtl/pe_imem.v rtl/pe_soc.v rtl/pe_pinmux.v rtl/pe_eth_mac.v rtl/pe_fbuf.v rtl/tt_um_protocol_emulator.v"
...
if command -v verilator >/dev/null 2>&1; then
  for top in pe_serdes pe_nrzi pe_manch pe_bitstuff pe_codec_mux pe_crc pe_dru pe_cpu \
             pe_imem pe_soc pe_pinmux pe_eth_mac pe_fbuf tt_um_protocol_emulator; do
...
if command -v yosys >/dev/null 2>&1; then
  for top in pe_serdes pe_codec_mux pe_crc pe_dru pe_cpu pe_imem pe_soc pe_pinmux pe_eth_mac pe_fbuf tt_um_protocol_emulator; do
