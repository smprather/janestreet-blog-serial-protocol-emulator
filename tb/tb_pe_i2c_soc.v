// tb_pe_i2c_soc.v — I2C pins on real RTL, driven entirely by firmware.
//
...
//      fixed-mask formula (see rtl/pe_uart_soc.v).
//
...
//      (gotcha 14).
//
// Program: firmware/i2c_pins.pe, assembled by tools/peasm.py.

`timescale 1ns / 1ps

module tb_pe_i2c_soc;
  ...
  // pe_uart_soc (see the header there); this is a TEST FACT about the board and
  ...
  // The I2C pins, from tools/peasm.py CONSTS: SDA = 0x10, SCL = 0x20.
  ...
  // intervals against the constants in tools/peasm.py.
  localparam real T_LOW_US = 7.0, T_HIGH_US = 6.0;

  initial begin
    $dumpfile("tb_pe_i2c_soc.vcd");
    $dumpvars(0, tb_pe_i2c_soc);
    ...
    // ~2000 cycles at 60 MHz (see tools/measure_i2c_timing.py). 20,000 covers
