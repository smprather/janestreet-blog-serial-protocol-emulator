...
that was byte-identical to the tree it came from.
    ...
    python3 tools/gen/render_block_diagram.py            # render, then stamp
    python3 tools/gen/render_block_diagram.py --check    # is the page unrendered?
"""
...
def check() -> int:
    ...
    if not STAMP.is_file():
        ...
        print("re-render with: python3 tools/gen/render_block_diagram.py", file=sys.stderr)
        return 1
