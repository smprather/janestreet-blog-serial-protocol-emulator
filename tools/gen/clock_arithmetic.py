...
CLK_HZ is read from rtl/pe_soc.v itself. If the RTL's clock ever changes
and this page is not regenerated, --check fails. That is the point: the RTL
owns the number and this page follows it.

    python3 tools/gen/clock_arithmetic.py           # write the page
    python3 tools/gen/clock_arithmetic.py --check    # exit 1 if stale
"""
