...
script fails rather than documenting it.
    ...
    python3 tools/gen_crc_config.py            # write the page
    python3 tools/gen_crc_config.py --check    # exit 1 if the page is stale

--check runs in tb/run_all.sh, so the page cannot drift from the table below.
