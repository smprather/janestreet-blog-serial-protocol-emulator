# pe_uart_soc.sdc — the design SDC for the full SoC, and the ONLY thing it adds
...
# trajectory and the same 812 buffers. See flow/pe_uart_soc.json for the PDN
...
puts "\[INFO\] pe_uart_soc.sdc: splitting clock uncertainty (setup vs hold)"
