# ---------------------------------------------------------------------------
# R3 debug-control screen: pe_soc / fast / BOARD-ASSUMPTION
# # SCREENING ASSUMPTION, NOT A SPEC. A same-board source-synchronous launch
# is assumed to arrive at the pad no earlier than 1.0 ns after its reference clock
# edge, and an external receiver's hold window no earlier than 1.0 ns after it. Every
# MET claim in this report is scoped to that assumption
...
set_input_delay -clock clk -min 1.0 [get_ports {rst_n host_* run pin_in* dbg_hold dbg_step dbg_rd_addr dbg_rd_dmem dbg_rd_req dbg_rd_data dbg_rd_valid}]
