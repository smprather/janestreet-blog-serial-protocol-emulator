...
| `dbg_hold` | inp | 1 | R3: debug hold routed from the host bus to pe_cpu. |
| `dbg_step` | inp | 1 | R3: step pulse routed from the host bus to pe_cpu. |
| `dbg_next_pc` | out | `[9:0]` | R3: the CPU's landing PC routed back to the host bus. |
